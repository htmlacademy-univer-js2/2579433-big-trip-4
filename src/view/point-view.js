...
function createPointTemplate(point) {
  ...
  return (
    `<li class="trip-events__item">
      <div class="event">
        <time class="event__date" datetime="${dateFrom.toISOString()}">${humanizeDate(dateFrom, FORMATS.shortDate)}</time>
        ...
        <div class="event__schedule">
          <p class="event__time">
            ...
            &mdash;
            <time class="event__end-time" datetime="${dateTo.toISOString()}">${humanizeDate(dateTo, FORMATS.timeOnly)}</time>
          </p>
